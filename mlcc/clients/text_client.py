...
class TextClient:
    ...
    def repl(self) -> None:
        ...
        while input_str.upper() != 'X':
            current_meal_str = '' if self.current_meal is None else f'[{self.get_current_meal_name().capitalize()}] '
            current_food_str = '' if self.current_food is None else f'[{self.get_current_food_name()}] '
            ...
            if input_str.upper() not in 'LCHOWFAIDESX':
                ...
                self.display_meals_of_the_day()
            elif input_str.upper() == 'O':
                self.set_current_meal()
            elif input_str.upper() == 'W':
                self.display_current_meal()
            elif input_str.upper() == 'F':
                self.add_current_food_to_current_meal()
            elif input_str.upper() == 'A':
                self.add_food_data()
            elif input_str.upper() == 'I':
                self.display_food_data()
